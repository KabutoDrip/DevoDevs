  ...
  return (
    <div style={{ fontFamily: "Poppins, sans-serif", padding: "20px" }}>
      ...
      <div style={{ marginTop: "20px" }}>
        <h1>Blogs</h1>
        <p>
          As licensed HVAC professionals in Southern Utah, we deliver quality,
          safety, and expertise in every project, meeting all state
          certifications and tailored to the unique needs of our local climate.
        </p>
